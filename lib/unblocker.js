...
function Unblocker(config) {
    ...
    function handleRequest(clientRequest, clientResponse, next) {
        ...
        console.log('mattvick: clientRequest.url: '+clientRequest.url);
        console.log('mattvick: clientRequest.protocol: '+clientRequest.protocol);
        console.log('mattvick: clientRequest.connection.encrypted: '+clientRequest.connection.encrypted);
        ...
        if (url_data.pathname.indexOf(config.prefix + "http") === 0) {
            ...
            if (formatted != clientRequest.url.substr(config.prefix.length)) {
                ...
                console.log('mattvick: clientRequest.protocol: '+clientRequest.protocol);
                console.log('mattvick: redirectTo('+formatted+')');
    ...
    function thisSite(request) {
        ...
        console.log('mattvick: thisSite(request): request.protocol: '+request.protocol);
    ...
    function redirectTo(request, response, site, headers) {
        ...
        console.log('mattvick: redirectTo(): request.thisSite(): '+request.thisSite());

        var test = request.thisSite(request) + site;

        console.log('mattvick: test: '+test);
